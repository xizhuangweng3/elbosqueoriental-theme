...
### 1.4 Key Project Documents

| Document      | Location                                   | Purpose                                                                                                         |
| ------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| This PRD      | `/PRD/BosqueNatural-PRD.md`              | Full product and technical requirements                                                                         |
| Content Bible | `/content/BosqueNatural-ContentBible.md` | All approved copy, messaging, blog outlines, SEO meta titles — single source of truth for all user-facing text |
| CLAUDE.md     | `/CLAUDE.md`                             | Claude Code intelligence file — coding standards, brand identity, file structure                               |
...
See the Content Bible (`/content/BosqueNatural-ContentBible.md`) Section 1 for full tone of voice rules. Summary:

* Balanced — expert but human. Like a knowledgeable friend with 40 years of health expertise
* Personal and direct — use "nosotros" and "tú"
...
### 9.3 Copy — Defer to Content Bible

All approved copy for the homepage, About page, product pages, collection descriptions, blog articles, contact page, email capture, navigation labels, and SEO meta titles is in the Content Bible at `/content/BosqueNatural-ContentBible.md`. Claude Code must read that document before writing any user-facing text. Do not write copy from scratch — use the Content Bible as the source of truth.
